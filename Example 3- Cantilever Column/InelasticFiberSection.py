...
# nonlinearBeamColumn element, uniaxial inelastic section with gravity loading
#(http://opensees.berkeley.edu/wiki/index.php/OpenSees_Example_3._Cantilever_Column_with_units)
